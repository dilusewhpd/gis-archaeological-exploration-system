...
const INITIAL_NOTIFICATIONS: Notification[] = [
  {
    id: "n-1",
    title: "New exploration sites approved",
    message: "Admin approved 3 new exploration logs in Anuradhapura. Ready for threat layer sync.",
    time: "4 hours ago",
    unread: true,
    actionLabel: "View map",
    actionHref: "/analyst/dashboard/gis-map",
  },
  {
    id: "n-2",
    title: "Vulnerability analysis scheduled",
    message: "Monthly reminder: run K-Means vulnerability threat simulation variables.",
    time: "2 days ago",
    unread: true,
    actionLabel: "Configure model",
    actionHref: "/analyst/dashboard/risk-assessment",
  },
  {
    id: "n-3",
    title: "System database synchronized",
    message: "12 new coordinates synced with Department of Archaeology Sri Lanka.",
    time: "4 days ago",
    unread: false,
  },
];
