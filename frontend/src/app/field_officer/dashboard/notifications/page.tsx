...
const INITIAL_NOTIFICATIONS: Notification[] = [
  {
    id: "n-1",
    title: "Exploration site approved",
    message: "Your submission for 'Sigiriya East Ridge' has been approved by the Admin.",
    time: "2 hours ago",
    unread: true,
    actionLabel: "View records",
    actionHref: "/field_officer/dashboard/records?status=approved",
  },
  {
    id: "n-2",
    title: "Correction requested",
    message: "Admin requested coordinate adjustments for 'Pidurangala Cave'. Review details.",
    time: "1 day ago",
    unread: true,
    actionLabel: "Edit record",
    actionHref: "/field_officer/dashboard/records?status=correction_requested",
  },
  {
    id: "n-3",
    title: "Welcome to the Archaeology Portal",
    message: "Hello J. Perera! Your account is active. Start logging exploration sites.",
    time: "5 days ago",
    unread: false,
  },
];
